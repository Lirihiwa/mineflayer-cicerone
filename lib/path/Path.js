...
class Path {
    ...
    clone() {
        const cloned = new Path(
            this.pathElements[0].position.clone(),
            this._actionRegistry,
            this._structureRegistry,
        );
        cloned.pathElements = this._cloneElements();
        cloned.lastPathElement = cloned.pathElements[cloned.pathElements.length - 1];
        return cloned;
    }
