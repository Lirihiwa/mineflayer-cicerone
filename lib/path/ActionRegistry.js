...
/**
 * @typedef {(position: import('vec3').Vec3, element: import('./PathElement')) => Promise<void>} ActionHandler
 * */
...
class ActionRegistry {
     ...
     * */
    async reverse(type, position, element) {
