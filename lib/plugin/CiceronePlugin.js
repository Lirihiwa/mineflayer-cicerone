...
const Digger = require('../actions/Digging');
const Placer = require('../actions/Placement');
...
class CiceronePlugin {
    ...
    static inject(bot, options = {}) {
        ...
        const digger = new Digger(bot, settings);
        const placer = new Placer(bot, settings);
     ...
     * @param {{ movement: Movement, digger: Digger, placer: Placer }} handlers
     * @private
     * */
